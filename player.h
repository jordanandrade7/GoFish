...
int delete_card_book_helper(struct player* target, char a);

int delete_card_book_helper2(struct player* target, char a, char b);

int find_index(struct player* target);
